...
class _LyricLaneRow extends ConsumerWidget {
  ...
  void _editLyric(
    ...
    showDialog<void>(
      context: context,
      builder: (_) => _LyricEditDialog(
        initialText: current,
        onSave: (text) => notifier.setBlockLyric(
          sectionId: section.id,
          laneId: lane.id,
          blockId: block.id,
          verseIndex: instanceIndex,
...
class _LyricEditDialog extends StatefulWidget {
  const _LyricEditDialog({required this.initialText, required this.onSave});
  final String initialText;
  final ValueChanged<String> onSave;

  @override
  State<_LyricEditDialog> createState() => _LyricEditDialogState();
}

class _LyricEditDialogState extends State<_LyricEditDialog> {
